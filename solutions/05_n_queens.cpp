...
public:
    ...
    void backtrack(vector<string>& board, int row, int n, set<int>& cols, set<int>& diag1, set<int>& diag2, vector<vector<string>>& res) {
        ...
        for (int col = 0; col < n; col++) {
            ...
            backtrack(board, row + 1, n, cols, diag1, diag2, res);
            board[row][col] = '.';
